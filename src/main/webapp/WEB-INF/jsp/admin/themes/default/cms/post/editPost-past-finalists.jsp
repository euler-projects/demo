...
<tr>
    ...
    <td style="width:320px;">
        <input id="e-ds-dashInputId" type="hidden" name="type" value="${post.type}">往届入围作品</td>
...
<tr><th>作品名称</th><td colspan="3">
<input class="easyui-textbox e-ds-dlg-input" name="title" style="width:700px;"
                            data-options="required:true" value="${post.title}">
</td></tr>
<tr><th>作者</th><td colspan="3">
<input class="easyui-textbox e-ds-dlg-input" name="post.extra.author" style="width:700px;"
                            data-options="required:true" value="${post.extra.author}"></td></tr>
<tr><th>团队成员</th><td colspan="3">
<input class="easyui-textbox e-ds-dlg-input" name="post.extra.member" style="width:700px;"
                            data-options="" value="${post.extra.member}"></td></tr>
<tr><th>组别</th><td colspan="3">
<input class="easyui-textbox e-ds-dlg-input" name="post.extra.group" style="width:700px;"
                            data-options="required:true" value="${post.extra.group}"></td></tr>
