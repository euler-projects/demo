        ...
        <table class="e-ds-dlg-fm-table e-ds-dlg-fm-slide-table">
            <tbody>
                ...
                <tr><td class="align-left">
                    <c:if test="${post.top == true}">
                        <label class="radio"><input type="radio" name="top" value="true" checked>置顶</label>
                        <label class="radio"><input type="radio" name="top" value="false">取消置顶</label>
                    </c:if>
                    <c:if test="${post.top == false}">
                        <label class="radio"><input type="radio" name="top" value="true">置顶</label>
                        <label class="radio"><input type="radio" name="top" value="false" checked>取消置顶</label>
                    </c:if>
                </td></tr>
                <tr><td class="align-left">
                    <c:if test="${post.approved == true}">
                        <label class="radio"><input type="radio" name="approved" value="true" checked>审核通过</label>
                        <label class="radio"><input type="radio" name="approved" value="false">待审核</label>
                    </c:if>
                    <c:if test="${post.approved == false}">
                        <label class="radio"><input type="radio" name="approved" value="true">审核通过</label>
                        <label class="radio"><input type="radio" name="approved" value="false" checked>待审核</label>
                    </c:if>
                </td></tr>
            </tbody>
        </table>
...
<input class="easyui-textbox e-ds-dlg-input" name="excerpt" style="width:700px;height:90px"
                            data-options="multiline:true" value="${post.excerpt}"></td></tr>
