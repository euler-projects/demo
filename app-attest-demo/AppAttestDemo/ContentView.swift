        ...
        GroupBox {
            VStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text("App Attest Challenge: /app_attest/challenge")
                    Text("App Attest Register:  /app_attest/register")
                    Text("OAuth2 Challenge:     /oauth2/challenge")
                    Text("OAuth2 Token:         /oauth2/token")
                }
