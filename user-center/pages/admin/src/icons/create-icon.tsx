 ...
 *   ]);
 */
export type IconPath = [tag: string, attrs: Record<string, string | number>];
...
export const createIcon = (
    ...
    CustomIconProps & React.RefAttributes<SVGSVGElement>
> => {
    const Component = React.forwardRef<SVGSVGElement, CustomIconProps>(
        function LucideStyleIcon(
            {
                color = 'currentColor',
                size = 24,
                strokeWidth = 2,
